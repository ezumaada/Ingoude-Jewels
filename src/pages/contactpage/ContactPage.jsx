        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
          <div className="flex items-center p-6 bg-gray-50 rounded-lg">
            ...
            <div>
              ...
              <p className="text-gray-600">indgoudelyxuryjewlry@outlook.com</p>
            </div>
          </div>
          ...
          <div className="flex items-center p-6 bg-gray-50 rounded-lg">
            ...
            <div>
              ...
              <p className="text-gray-600">+1 (954) 858-4700</p>
            </div>
          </div>
          ...
          <div className="flex items-center p-6 bg-gray-50 rounded-lg md:col-span-2 lg:col-span-1">
            ...
            <div>
              ...
              <p className="text-gray-600">131 Business Street, Se 3rd Avenue, Denver</p>
            </div>
          </div>
        </div>
